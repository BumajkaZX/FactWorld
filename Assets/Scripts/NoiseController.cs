...
namespace FactWorld
{
    public class NoiseController : MonoBehaviour
    {
        ...
        public int NoiseLiveStep { get => _noiseLiveStep; set => _noiseLiveStep = value; }
        public List<GameObject> NoiseList { get => noiseListObject; set => noiseListObject = value; }
        ...
        [SerializeField] private int _noiseLiveStep;
